...
core.register_node("mydeck:pile", {
	description = "Pile",
	tiles = {
...
core.register_node("mydeck:pile_wpost", {
	description = "Pile",
	tiles = {
...
core.register_node("mydeck:post", {
	description = "Post",
	tiles = {
	...
	after_place_node = function(pos, placer, itemstack, pointed_thing)
		...
		local node = core.get_node({x=pos.x, y=pos.y-1, z=pos.z}).name
		local nodep = core.get_node({x=pos.x, y=pos.y-1, z=pos.z})
		local nodeo = core.get_node({x=pos.x, y=pos.y+1, z=pos.z})
		...
		if node == "mydeck:pile" then
		   core.set_node({x=pos.x, y=pos.y-1, z=pos.z},{name = "mydeck:pile_wpost", param2=nodep.param2})
		end
		
		if nodeu == "mydeck:beam" then
		   core.set_node({x=pos.x, y=pos.y+1, z=pos.z},{name = "mydeck:beam_wbracket", param2=node.param2})
		end
		if nodeu == "mydeck:joists_beam" then
		   core.set_node({x=pos.x, y=pos.y+1, z=pos.z},{name = "mydeck:joists_beam_wbracket", param2=nodeo.param2})
		end
		if nodeu == "mydeck:joists_side_beam" then
		   core.set_node({x=pos.x, y=pos.y+1, z=pos.z},{name = "mydeck:joists_side_beam_wbracket", param2=nodeo.param2})
		end
		if nodeu == "mydeck:deck_joists_beam" then
		   core.set_node({x=pos.x, y=pos.y+1, z=pos.z},{name = "mydeck:deck_joists_beam_wbracket", param2=nodeo.param2})
		end
		if nodeu == "mydeck:deck_joists_side_beam" then
		   core.set_node({x=pos.x, y=pos.y+1, z=pos.z},{name = "mydeck:deck_joists_side_beam_wbracket", param2=nodeo.param2})
		end
	end
})
